...
public class ReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("an office worker", "en kontors arbetare", R.drawable.office_worker, R.raw.en_kontors_arbetare));
        ...
        words.add(new Word("the only child", "endabarn", R.drawable.boy, R.raw.endabarn));
        ...
        words.add(new Word("I watch a movie", "Jag tittar på en film", R.drawable.video, R.raw.jag_tittar_pa_film));
        ...
        words.add(new Word("I visit an old city", "Jag besöker en gammal stad.", R.drawable.building, R.raw.jag_besoker_en_gammal_stad));
        words.add(new Word("I relax", "Jag kopplar av", R.drawable.relax, R.raw.jag_kopplar_av));
